class Load extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.spritesheet('fox3', 'water_boi.png', {frameWidth: 148, frameHeight: 96, startFrame: 0, endFrame: 4});
        this.load.spritesheet('fox4', 'base_fox2.png', {frameWidth: 148, frameHeight: 96, startFrame: 0, endFrame: 4});
        this.load.spritesheet('fox5', 'base_fox2.png', {frameWidth: 148, frameHeight: 96, startFrame: 0, endFrame: 4});
        this.load.spritesheet('fox6', 'base_fox2.png', {frameWidth: 148, frameHeight: 96, startFrame: 0, endFrame: 4});
        this.load.spritesheet('fox7', 'base_fox2.png', {frameWidth: 148, frameHeight: 96, startFrame: 0, endFrame: 4});
        this.load.spritesheet('fox8', 'base_fox2.png', {frameWidth: 148, frameHeight: 96, startFrame: 0, endFrame: 4});
        this.load.spritesheet('fox9', 'base_fox2.png', {frameWidth: 148, frameHeight: 96, startFrame: 0, endFrame: 4});
